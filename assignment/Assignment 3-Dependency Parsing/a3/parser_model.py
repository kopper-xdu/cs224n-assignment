...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        emded_to_hidden_weight = torch.empty(self.embed_size * self.n_features, self.hidden_size)

        self.embed_to_hidden_weight = nn.Parameter(nn.init.xavier_uniform_(emded_to_hidden_weight))
